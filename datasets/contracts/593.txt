...
use near_sdk::{
    ...
    serde_json::json, BorshStorageKey,
};
    ...
    pub fn new_default_meta(owner_id: AccountId, vault_id: AccountId) -> Self {
        ...
        Self::new(
            ...
            NFTContractMetadata {
                ...
                name: "Monkeonnear Collectibles".to_string(),
                symbol: "Monkeonnear".to_string(),
                icon: Some("https://bafybeiewifgrsp55e34ucrcyk4y4ntdmbk3hqzuenfejuxfw5zs2p6ckda.ipfs.dweb.link/0.png".to_string()),
                base_uri: None,
                reference: None,
                reference_hash: None,
            },
